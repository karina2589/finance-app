  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        selectedLabelStyle:  GoogleFonts.ubuntu(fontSize: 11, color: Colors.grey.shade400, fontWeight: FontWeight.w500),
        unselectedLabelStyle:  GoogleFonts.ubuntu(fontSize: 10, color: Colors.grey.shade600, fontWeight: FontWeight.w500),
